...
import { AppTab, TabItem } from "@/components/parts/AppTab";
import { useAtomValue } from "jotai";
import { presentationAgentStateAtom } from "@/atoms/presentationAgentStateAtom";
import { InterviewResult } from "./-components/InterviewResult";
import { PresentationSuggestion } from "./-components/PresentationSuggestion";
export const Route = createFileRoute("/_auth/presentation/result")({
...
function RouteComponent() {
  ...
  const tabItems: TabItem[] = [
      ...
      content: (
        <div className="p-2 space-y-2">
          <div className="flex flex-col gap-4">
            <InterviewResult
              interviewResults={presentationAgentState.interview_result}
            />
          </div>
        </div>
      ),
    ...
    {
      title: "Presentationの構成提案",
      value: "2",
      content: (
        <div className="p-4 space-y-2">
          <PresentationSuggestion
            presentation={presentationAgentState.presentation}
          />
        </div>
      ),
    },
  ...
  return (
    <CustomeCard
      title="インタビュー結果とプレゼンの提案結果"
      description="先ほど作成したペルソナに対するインタビュー結果とプレゼンの提案結果を確認してください。"
      footer={footer}
    >
